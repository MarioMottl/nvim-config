...
return {
    {
        ...
        keys = {
            -- Floating Copilot Chat
            {
                "<leader>cc",
                function()
                    require("CopilotChat").toggle({ window = { layout = "float", name = "CopilotChatFloat" } })
                end,
                desc = "Copilot Chat (float)",
            },
            -- Vsplit Copilot Chat
            {
                "<leader>cC",
                function()
                    vim.cmd("vsplit")
                    require("CopilotChat").toggle({ window = { layout = "vsplit" } })
                end,
                desc = "Copilot Chat (vsplit)",
            },
        },
        config = function()
